...
<link href="<?=SITE_TEMPLATE_PATH?>/css/style.css?v=21" type="text/css"  rel="stylesheet">
...
<link href="<?=SITE_TEMPLATE_PATH?>/css/components/titles.css?v=31" type="text/css"  rel="stylesheet">
			...
			<div class="container">
				<div class="header__inner">
					<div class="logo">
						...
						<p class="logo__tagline">production <br>of ATVs</p>
					</div>
					<nav class="header-nav">
						...
						<ul itemscope itemtype="http://schema.org/SiteNavigationElement" class="header-nav__list">
							<li class="header-nav__item">
								<span class="header-nav__link header-nav__link--drop">Models</span>
								<ul class="header-nav__dropdown">
									...
									<li class="header-nav__dropdown-item header-nav__dropdown-item--dropdown-img">
										<img class="header-nav__dropdown-img" src="<?=SITE_TEMPLATE_PATH?>/img/navigation-models.webp" alt="All-terrain vehicles TINGER">
									</li>
								</ul>
							</li>

							<li class="header-nav__item">
								<a itemprop="url" class="header-nav__link" href="/configurator/">Configurator</a>
							</li>

							<li class="header-nav__item">
								<span class="header-nav__link header-nav__link--drop">Owners</span>
								<ul class="header-nav__dropdown">
									<li class="header-nav__dropdown-item">
										<ul class="header-nav__menu">
											<li class="header-nav__menu-item">
												<a itemprop="url" class="header-nav__menu-link" href="/customer-support/">Customer support</a>
											</li>
											<li class="header-nav__menu-item">
												<a itemprop="url" class="header-nav__menu-link" href="/service/">Service</a>
											</li>
											<li class="header-nav__menu-item">
												<a itemprop="url" class="header-nav__menu-link" href="/warranty/">Warranty</a>
											</li>
											<li class="header-nav__menu-item header-nav__menu-item--menu-img">
												<img class="header-nav__menu-img" src="<?=SITE_TEMPLATE_PATH?>/img/navigation-owners.webp" alt="Wheeled ATVs">
											</li>
										</ul>
									</li>
								</ul>
							...
							<li class="header-nav__item">
								<span class="header-nav__link header-nav__link--drop">About us</span>
								<ul class="header-nav__dropdown">
									<li class="header-nav__dropdown-item">
										<ul class="header-nav__menu">
											<li class="header-nav__menu-item">
												<a itemprop="url" class="header-nav__menu-link" href="/about/">About us</a>
											</li>
											<li class="header-nav__menu-item">
												<a itemprop="url" class="header-nav__menu-link" href="/production/">Production</a>
											</li>
											<li class="header-nav__menu-item">
												<a itemprop="url" class="header-nav__menu-link" href="/news/">News</a>
											</li>
											<li class="header-nav__menu-item header-nav__menu-item--menu-img">
												<img class="header-nav__menu-img" src="<?=SITE_TEMPLATE_PATH?>/img/navigation-company.webp" alt="Tracked ATVs">
											</li>
										</ul>
									</li>
								</ul>
							...
							<li class="header-nav__item">
								<a itemprop="url" class="header-nav__link" href="/dealers/">Dealers</a>
							</li>
						</ul>
					</nav>
					<div class="header-nav__services">
						<a class="header-nav__phone-link" href="tel:+1 (929) 999-21-56" title="Call to us">
						...
						<div class="header-nav__lang-container">
							<select class="header-nav__lang select">
