...
<form class="form maintenance-form margin_b_m">
	<div class="maintenance-form__inner">
		<label class="maintenance-form__item">
		...
		<label class="maintenance-form__item">
			<input class="h5 input-field" type="text" name="mileage" placeholder="Пробег (км, мото/ч)">
		</label>

		<label class="maintenance-form__item">
			<input class="h5 input-field" type="text" name="name" placeholder="Имя">
		</label>

		<label class="maintenance-form__item">
			<input class="h5 input-field" type="tel" name="phone" placeholder="Телефон*" required>
		</label>
		...
		<label class="maintenance-form__item form-policy">
		...
		<div class="maintenance-form__btn-container">
...
<p class="p">Запись на ТО телефону <a href="tel:8 (800) 350-25-05">8 (800) 350-25-05</a> (доб. 702) <br>и по электронной почте <a href="mailto:garant@tinger.ru">garant@tinger.ru</a></p>