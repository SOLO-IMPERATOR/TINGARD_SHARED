...
$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'catalog.element', $componentElementParams,
	$component
);

?>
<section class="section section_padding-top_small section_padding-bottom_small">
	<div class="section-title section-title_margin_bottom">Похожие товары</div>
