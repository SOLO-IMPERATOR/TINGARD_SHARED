...
?>
<div class="selection-products swiper">
	<!-- items-container -->
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])) {
		...
		?>
		<div class="selection-products__slider-wrapper swiper-wrapper" itemscope itemtype="http://schema.org/ItemList">
		<?
		...
		unset($generalParams);
	?>
	<div class="selection-products__swiper-arrows arrows">
