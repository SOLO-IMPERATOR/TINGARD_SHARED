const smartFilterSelector = document.querySelector('.smart-filter');
const smartFilterTitleSelector = smartFilterSelector.querySelector('.smart-filter-title');
smartFilterTitleSelector.addEventListener('click', () => {
	smartFilterSelector.classList.toggle('smart-filter_visible');
});
