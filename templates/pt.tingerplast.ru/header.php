...
<script>
	...
	})(window,document,'https://cdn-ru.bitrix24.ru/b1538393/crm/site_button/loader_52_njsk1d.js');
</script>

<script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date(); for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === r) { return; }} k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(93172053, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true, trackHash:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/93172053" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
...
<?$APPLICATION->SetPageProperty('canonical', 'https://pt.tingerplast.ru' . $APPLICATION->GetCurPage())?>
			...
			<div class="header__inner container">
				...
				<div class="header__nav">
					<nav class="nav">
						<ul class="nav__list">
							<li class="nav__item">
								<a class="nav__link" href="/#models">Каталог</a>
							</li>
							<li class="nav__item">
								<a class="nav__link" href="/#compare">Преимущества</a>
							</li>
							<li class="nav__item">
								<a class="nav__link" href="/#mounting">Монтаж</a>
							</li>
							<li class="nav__item">
				...
				<div class="header__phone-container">
					<div class="header__phone">
						<a class="header__phone-link" href="tel:8 (800) 350-81-69">8 (800) 350-81-69</a>
						<div class="header__worktime">пн-пт c 9:00 до 18:00</div>
					</div>
				</div>
			</div>
		</header>