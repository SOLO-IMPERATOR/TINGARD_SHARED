...
foreach ($arResult["QUESTIONS"] as $item){
	$dbUser = \Bitrix\Main\UserTable::getList(array(
		...
		'filter' => array('ID' => $item['FIELD_TYPE'])
	));

	$arIDUsers[$item['ID']] = $dbUser->fetch();
}
$classFill = Checkhelp::getCheckColor($arResult["QUESTIONS"]);
$arResult['CHECK_FILL'] = $classFill;
$arResult['RESPONSIBLE_USER'] = $arIDUsers;
?>