...
function submitForm(event) {
	...
	const formDataObj = {
		...
		mileage: form.querySelector('input[name="mileage"]').value,
	...
	formData.append('comment', '<b>Вездеход: </b>' + formDataObj.model + '<br><b>Пробег: </b>' + formDataObj.mileage + '<br><b>Пожелания клиента: </b>' + formDataObj.question);
