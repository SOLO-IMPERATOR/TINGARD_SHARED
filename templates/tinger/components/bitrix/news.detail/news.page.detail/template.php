		...
		<article class="news__inner">
			<div class="news__about">
				...
				<div class="author margin_b_m">
					<img class="author__img" src="<?=$arResult['PROPERTIES']['AUTHOR']['AUTHOR_PHOTO']?>" alt="<?=$arResult['PROPERTIES']['AUTHOR']['AUTHOR_NAME']?> <?=$arResult['PROPERTIES']['AUTHOR']['AUTHOR_LASTNAME']?>">
					<p itemprop="author" class="author__name"><?=$arResult['PROPERTIES']['AUTHOR']['AUTHOR_NAME']?> <?=$arResult['PROPERTIES']['AUTHOR']['AUTHOR_LASTNAME']?></p>
				</div>
			</div>
