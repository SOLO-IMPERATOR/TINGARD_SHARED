	...
	<ul class="search-form__list">
		...
		<li class="search-form__item-container">
			<a class="search-form__item search-form__item_type_result" href="<?=$arItem['URL']?>">
				...
				<ul class="search-form__categories">
					<?foreach($arItem['SECTIONS'] as $arItemSection):?>
					<li class="search-form__category"><?=$arItemSection['SECTION_NAME'] . ' - ' . $arItemSection['SUBSECTION_NAME']?></li>
					<?endforeach?>
				</ul>
			</a>
		</li>
		...
		<li class="search-form__item-container">
			<div class="search-form__item">
				<a class="search-form__link" href="<?=$arResult['CATEGORIES']['all']['ITEMS'][0]['URL']?>"><?=$arResult['CATEGORIES']['all']['ITEMS'][0]['NAME']?></a>
			</div>
		</li>
	</ul>
<?endif;?>