...
<main>
	<section class="section container">
		<h1 class="page-title margin_b_m"><?if($arResult['SECTION']['DEPTH_LEVEL']==0):?><?='Каталог оригинальных запчастей'?><?else:?><?=isset($arResult['SECTION']["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"]) && $arResult['SECTION']["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"] != "" ? $arResult['SECTION']["IPROPERTY_VALUES"]["SECTION_PAGE_TITLE"] : $arResult['SECTION']['NAME']?><?endif?></h1>																																				
