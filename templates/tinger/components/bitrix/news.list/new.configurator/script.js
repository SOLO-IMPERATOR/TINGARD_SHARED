...
/* navigation panel (configurator) */

/* models slider (configurator, 1 step) 
const swiperModelsConf = new Swiper('.conf-models__swiper', {
	slidesPerView: 'auto',
	freeMode: true,
	simulateTouch: true,
	mousewheel: {
...
function disablingPackages(code) {
    const packs = $('section[data-page=conditions][data-simbol-code=' + code + '] .conf-widget__package');
    const modules = $('section[data-page=conditions][data-simbol-code=' + code + '] .conf-widget__options-item');
