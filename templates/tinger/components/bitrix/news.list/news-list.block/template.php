...
<div class="news-widget">
    ...
    <div class="news-widget__bottom">
        <div class="news-widget__link-container">
            <a href="/<?=$arResult["CODE"]?>/">Посмотреть все</a>
        </div>
        <div class="news-widget__arrows arrows">
            <button class="news-widget__arrows-prev arrows__btn"><img class="arrows__img" src="/local/templates/tinger/img/arrow-prev.svg" alt="Стрелка назад"></button>
            <button class="news-widget__arrows-next arrows__btn"><img class="arrows__img" src="/local/templates/tinger/img/arrow-next.svg" alt="Стрелка вперёд"></button>
        </div>
    </div>
</div>