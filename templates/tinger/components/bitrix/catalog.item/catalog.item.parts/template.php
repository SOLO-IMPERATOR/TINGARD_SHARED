...
<div class="parts-category__item" itemscope itemprop="itemListElement" itemtype="http://schema.org/Product">
	...
	<div class="parts-category__item-price" itemscope itemprop="offers" itemtype="http://schema.org/Offer">
		<meta itemprop="price" content="<?=$arResult['ITEM']['ITEM_PRICES'][0]['BASE_PRICE']?>">
		...
		<?=$arResult['ITEM']['ITEM_PRICES'][0]['PRINT_RATIO_BASE_PRICE']?>
	</div>
	<div class="parts-category__item-button-container">
		<button class="parts-category__item-button add-to-cart-btn" type="button" data-id="<?=$arResult['ITEM']['ID']?>" data-url="<?=$arResult['ITEM']['DETAIL_PAGE_URL']?>"<?if($arResult['ITEM']['PRODUCT']['AVAILABLE'] =="N"):?> disabled<?endif?>>В корзину<span class="tooltip tooltip_position_left"></span></button>
	</div>
</div>