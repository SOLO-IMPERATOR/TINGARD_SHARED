...
function creationLead($data)
{
    ...
    if ($data['UTM']) {
        $utmList = array_change_key_case($data['UTM'], CASE_UPPER);
    } else {
        $utmList = [];
    }
    ...
    $generalFields = [
        ...
        'SECOND_NAME' => "",
        'LAST_NAME' => "",
        'UF_CRM_1517561552' => $roistatVisitId, //roistat
    ];

    $fields = array_merge($generalFields, $utmList);
    ...
    if ($data["UF_CRM_1449663065"]) {
        $fields["UF_CRM_1449663065"] = $data["UF_CRM_1449663065"];
    } else {
        $fields["UF_CRM_1449663065"] = 64;
    }
